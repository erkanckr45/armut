...
process.env.DATABASE_URL = "postgresql://neondb_owner:npg_sbjQ7c2ThyfV@ep-autumn-bonus-amd88j7g-pooler.c-5.us-east-1.aws.neon.tech/neondb?sslmode=require"
...
async function main() {
  ...
  for (const cat of categories) {
    ...
    count++
    console.log(`✅ [${count}/${categories.length}] ${cat.name} eklendi`)
  }
  
  console.log(`🎉 ${count} kategori başarıyla eklendi!`)
}
